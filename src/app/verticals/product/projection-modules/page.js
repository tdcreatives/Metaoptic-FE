...
import ProjectionModulesClientSide from './ProjectionModulesClientSide';
...
const ProjectionModulesPage = () => {
    return <ProjectionModulesClientSide />;
};

export default ProjectionModulesPage;
