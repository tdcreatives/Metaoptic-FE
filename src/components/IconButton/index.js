    ...
    return (
        <div
            ...
            <button
                ...
                onClick={onClick}>
                <div className="flex flex-col sm:flex-row items-center w-full px-10">
                    ...
                    <span className='z-10 relative mt-2 sm:mt-0 text-center sm:text-right w-full sm:w-1/4 sm:pl-4 md:group-hover:!text-white transition-colors duration-300 flex items-center justify-center sm:justify-end'>
