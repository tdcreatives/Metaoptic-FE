        ...
        <div
            ...
            <button
                ...
                <div className="flex flex-col sm:flex-row items-center w-full gap-4 sm:gap-0">
                    <span className={`z-10 relative text-left sm:text-left w-full sm:w-3/4 sm:pr-4 md:group-hover:!text-white transition-colors duration-300 ${classNameLabel || ''}`} dangerouslySetInnerHTML={{ __html: label }}></span>
