        ...
        <div
            ...
            <button
                ...
                <div className="flex flex-col sm:flex-row items-center w-full gap-2 sm:gap-0">
                    <span className={`z-10 relative text-left sm:text-left w-full sm:w-3/4 sm:pr-4 pt-2 sm:pt-0 md:group-hover:!text-white transition-colors duration-300 ${classNameLabel || ''}`} dangerouslySetInnerHTML={{ __html: label }}></span>
                    <span className='z-10 relative text-center sm:text-right w-full sm:w-1/4 sm:pl-4 md:group-hover:!text-white transition-colors duration-300 flex items-center justify-center sm:justify-end'>
                        <span className='w-8 h-8 sm:w-[42px] sm:h-[42px] flex items-center justify-center'>{icon}</span>
                    </span>
                </div>
                {/* Default background */}
                <span
