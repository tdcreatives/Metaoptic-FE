    ...
    return (
        <section
            ...
            <div className='flex flex-col'>
                ...
                <div className='bg-[#ebebeb] xl:p-8 p-4 rounded-lg'>
                    <p className='text-[18px] mb-6 xl:max-w-[39%] max-w-full'>
            ...
            <div className='xl:absolute relative right-0 xl:w-[58%] w-[95%] mx-auto h-fit xl:mt-0 mt-10'>
                <div className='grid grid-cols-2 xl:gap-4 gap-3'>
                    ...
                    <div className='flex flex-col xl:gap-4 gap-3 mb-[-48px] mt-[52px]'>
                        <motion.div
                            className='relative rounded-lg overflow-hidden shadow-lg'
                            whileHover={{
                                rotateX: 5,
