  ...
  return (
    <section className="2xl:px-[104px] 2xl:py-[80px] xl:px-[50px] xl:py-[60px] lg:px-[40px] lg:py-[50px] py-10 px-6 bg-white">
      <div className="max-w-[1320px] mx-auto">
        <h2 className="xl:text-[40px] lg:text-[32px] text-[28px] futura-condensed-medium font-medium text-[#d34c39] uppercase border-b border-[#D9D9D9] pb-4">
          {title}
        </h2>

        {description && (
          <p className="xl:text-[16px] lg:text-[15px] text-[14px] text-black mt-6 leading-relaxed">
            {description}
          </p>
        )}
        ...
        <div className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-6 mt-10">
          {items?.map((item, index) => (
            ...
            >
              ...
              <h3 className="text-[20px] futura-medium font-medium text-[#d34c39]">
                {item.title}
              </h3>
