    ...
    <section className="2xl:px-[104px] 2xl:py-[80px] xl:px-[50px] xl:py-[60px] lg:px-[40px] lg:py-[50px] py-10 px-6 bg-white">
      <div className="max-w-[1320px] mx-auto">
        ...
        <div className="overflow-x-auto mt-10">
          <table className="w-full border-collapse xl:text-[20px] lg:text-[18px] text-[14px]">
            {headers?.length > 0 && (
              <thead>
                <tr className="bg-[#EAEAEA]">
                  {headers.map((h, i) => (
                    <th
                      key={i}
                      className={`border border-[#D9D9D9] px-4 py-4 text-center font-medium ${
                        i === 0 ? "text-[#000]" : "text-[#676767]"
                      }`}
                    >
                      {h}
                    </th>
                ...
                <tr key={idx}>
                  ...
                  {row.merged !== undefined ? (
                    <td
                      ...
                      className="border border-[#D9D9D9] px-4 py-4 text-center font-medium text-[#555]"
                    >
                      {row.merged}
                    </td>
                  ) : (
